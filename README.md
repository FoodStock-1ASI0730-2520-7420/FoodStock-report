...
| 35 | Cambiar fecha de reservación                    | Como usuario quiero cambiar la fecha y hora de una reservación existente para poder ajustarla según la disponibilidad del cliente.                          | Escenario 1: Cambio exitoso. Dado que el usuario selecciona una reservación registrada. Cuando modifica la fecha y hora por una disponible y guarda. Entonces el sistema actualiza la reservación con la nueva fecha y hora. Escenario 2: Fecha no disponible. Dado que el usuario selecciona una reservación. Cuando intenta cambiar la fecha a una ya ocupada. Entonces el sistema muestra un mensaje de error indicando que el horario no está disponible.                                                                                                                                                                                                                                                                                                        | 3                         |
| 36 | Filtrar reservaciones                           | Como usuario quiero filtrar las reservaciones por fecha, cliente o estado para encontrar rápidamente la información que necesito.                         | Escenario 1: Filtrado por fecha. Dado que el usuario se encuentra en la ventana de “Reservaciones”. Cuando selecciona un rango de fechas en el filtro. Entonces el sistema muestra solo las reservaciones registradas en ese periodo. Escenario 2: Filtrado por cliente/estado. Dado que el usuario se encuentra en la ventana de “Reservaciones”. Cuando ingresa el nombre del cliente o selecciona el estado (ej. activa, cancelada). Entonces el sistema muestra únicamente las reservaciones que cumplen con el criterio.                                                                                                                                                                                                                                                                                                                                                                                                             | 3                         |
| 37 | Exportar reservaciones                          | Como usuario quiero exportar la lista de reservaciones a un archivo (PDF o Excel) para poder compartirla o guardarla como respaldo.                         | Escenario 1: Exportación exitosa. Dado que el usuario se encuentra en la ventana de “Reservaciones”. Cuando selecciona la opción “Exportar” y elige un formato (PDF/Excel). Entonces el sistema genera el archivo y lo descarga en el dispositivo. Escenario 2: Exportación sin datos. Dado que no existen reservaciones registradas. Cuando el usuario intenta exportar. Entonces el sistema muestra un mensaje indicando que no hay información para exportar.                                                                                                                                                                                                                                                                                                   | 3                         |
